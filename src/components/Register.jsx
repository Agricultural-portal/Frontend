  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedRole === "farmer") {
        response = await authService.registerFarmer(formData);
      } else if (selectedRole === "buyer") {
        response = await authService.registerBuyer(formData);
        ...
        <Card className="shadow-xl border-none">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button type="submit" className="w-full shadow-lg h-12 text-base" disabled={loading}>
